    ...
    <TooltipProvider>
      <ScrollArea className="h-full">
        <div className="p-6 space-y-6 max-w-7xl mx-auto">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    Recherchez des dossiers patients existants par CIN ou ID, et consultez leurs informations.
                  </p>
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <Card className="mb-6">
            <CardHeader><CardTitle>Recherche Patient</CardTitle></CardHeader>
            <CardContent>
              <div className="flex space-x-4">
                <div className="flex-1 relative">
                  <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
                  <Input
                    placeholder="Rechercher par CIN ou ID patient..."
                    value={searchTerm}
          ...
          <Card>
            <CardHeader><CardTitle>Liste des Patients</CardTitle></CardHeader>
            <CardContent>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-4 flex-shrink-0">
                      ...
                      <Badge variant={patient.status === "active" ? "default" : patient.status === "completed" ? "secondary" : "outline"}>
                        {patient.status === "active" ? "Actif" : patient.status === "completed" ? "Terminé" : "En attente"}
                      </Badge>
